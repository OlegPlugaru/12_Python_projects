...
Dictionay makes it easy to have key-value pairs.
...
# ---------------------------------------------------------------------------
# Louis also took Geography and scored 70
# ---------------------------------------------------------------------------
...
python1_score = marks.get("Python")
if python_score is not None:
    print(f"Louis scored {python_score} in Python")
else:
    print("No score found for Python")
...
# Alternative 2 - Preferred Appproach
# -----------------------------------------
