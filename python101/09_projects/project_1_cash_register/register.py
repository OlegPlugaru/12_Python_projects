...
cr2.add_item(milk, quantity=4, discount=10)
cr2.add_item(egg, quantity=25)
cr2.update_item(egg, quantity=48, discount=12)
cr2.add_item(apple, quantity=8, discount=2)
